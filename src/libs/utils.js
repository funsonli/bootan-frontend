...
util.setCurrentPath = function (vm, name) {
  ...
  if (name === 'home_index') {
    ...
    if (currentPathObj && currentPathObj.children && currentPathObj.children.length <= 1 && currentPathObj.name === 'home') {
      currentPathArr = [
        {
          title: '首页',
          path: '',
    ...
    } else if (currentPathObj && currentPathObj.children && currentPathObj.children.length <= 1 && currentPathObj.name !== 'home') {
      currentPathArr = [
        {
          title: '首页',
          path: '/home',
...
util.initRouter = function (vm) {
  ...
  if (!vm.$store.state.app.added) {
    ...
    axios.get(getMenuList, { headers: { 'access-token': accessToken } }).then(res => {
      ...
      vm.$store.state.app.routers = vm.$store.state.app.routers.slice(1, vm.$store.state.app.routers.length)
...
util.initRouterNode = function (routers, data) {
  for (var item of data) {
    ...
    // menu.component = import(`@/view/${menu.component}.vue`)
